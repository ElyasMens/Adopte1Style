...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 07 juin 2024 à 12:40
...
INSERT INTO `profile_view` (`id`, `user_visited`, `user_visitor`) VALUES
(1, 'Julien', 'Admin'),
(2, 'Julien', 'DiMaria'),
(3, 'DiMaria', 'Admin'),
(4, 'Julien', 'Zlatan'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `module` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'user',
  PRIMARY KEY (`id`)
...
(7, 'Julien', 'samy@gmail.com', 'Julien', '$2y$10$AceWIJDiedouKZQnuE39O.Beasd.UXi7/mXxnAcTcj6hTneCQBP/C', 'subscriber'),
(8, 'Admin', 'admin@gmail.com', 'Admin', '$2y$10$6jHL4ZhgZc/bWtxa4FoxbO22E836oYJjlm83yBD1EEcEqTWzjZ5i.', 'admin'),
(41, 'abcdefg', 'abcdefg@gmail.com', 'abcdefg', '$2y$10$97Kq.hlJPKvU7WuhdEt20eFBjNbsH4UYS0Ul96Ve4LtKpbWU5dUx.', 'user');
...
(6, 'Adminsqd', 'adminsqdsq@gmail.com'),
(11, 'adzebcdefg', 'abdzecdefg@gmail.com'),
(12, 'lol', 'azerty');
...
--
-- Déchargement des données de la table `users_blocked`
--

INSERT INTO `users_blocked` (`id`, `user_blocked`, `blocked_by`) VALUES
(3, 'Zlatan', 'Julien');
...
CREATE TABLE IF NOT EXISTS `users_info` (
  ...
  `birthdate` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `job` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_location` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `relation` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `user_size` int NOT NULL,
  `user_weight` int NOT NULL,
  `eye_color` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `hair_color` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `user_photo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `users_reported` (
  ...
  `user_reported` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reported_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(22, 'Admin', 'Julien', 'spam', 15, '😂😂', '2024-06-07 11:43:21'),
(23, 'Admin', 'Julien', 'spam', 17, 'abdedzdezdzdadaz', '2024-06-07 11:43:22');
COMMIT;
