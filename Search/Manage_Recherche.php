...
function Show_LastUsers(){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<li class='user-info show-user' data-username='{$row['username']}' data-birthdate='{$row['birthdate']}' data-location='{$row['user_location']}' data-gender='{$row['gender']}' data-job='{$row['job']}' data-size='{$row['user_size']}' data-style='{$row['style']}'>
    ...
    while ($hidden_row = $stmt_hidden->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<li class='user-info hide-user' data-username='{$hidden_row['username']}' data-birthdate='{$hidden_row['birthdate']}' data-location='{$hidden_row['user_location']}' data-gender='{$hidden_row['gender']}' data-job='{$hidden_row['job']}' data-size='{$hidden_row['user_size']}'data-style='{$hidden_row['style']}'>
                <img src='{$user_pp}' alt='Profile Picture'>
                <div class='user-info-content'></div> 
                <div class='user-info-option'>
